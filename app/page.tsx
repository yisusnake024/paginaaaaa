    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 text-left">
      ...
      <div className="p-6 sm:p-8 border border-white/20 rounded-2xl shadow-lg bg-white/10 backdrop-blur-sm">
        ...
        <ul className="space-y-3 text-white/90">
          <li>📅 [11 Nov 2025] - Lanzamiento Oficial de la pagina del CIEF</li>
          <li>📅 [10 Nov 2025] - Se da Apertura a las redes sociales del CIEF</li>
      ...
      <div className="p-6 sm:p-8 border border-white/20 rounded-2xl shadow-lg bg-white/10 backdrop-blur-sm">
        ...
        <hr className="my-3 border-white/30" />
        <ul className="space-y-3 text-white/90">
          <li>📅 [10 Nov 2025] - Evento Internacional: “IV Jornada Internacional De Ingenierias”</li>
          <li>📅 [2 Oct 2025] - Seminario Dimensión de Trabajo X</li>
          <li>📅 [18 Sep 2025] - Presentación de Policy Brief Y</li>
        </ul>
        <Link
          href="/agenda"
          className="block mt-6 text-[#FFB000] hover:underline text-sm font-medium"
